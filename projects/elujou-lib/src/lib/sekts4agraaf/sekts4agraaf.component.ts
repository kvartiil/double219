...
@Component({
  selector: 'sekts4agraaf',
  templateUrl: './sekts4agraaf.component.html',
  styleUrls: [ './sekts4agraaf.component.scss' ],
  standalone: true,
...
export class Sekts4agraafComponent implements OnInit  {
  ...
  constructor () {
    ...
    this.newdata =  [   //Iga valdkonna jaoks on eraldi datamatrix
      [this.kysiAKM(), 0, 4],  //Esimesel kohal number tähendab näitaja suurust (antud juhul 1.4)
      [this.minuAKM, 0, 4.01],
...
////}
  ...
  naitajad = [
    '     Käibe ärirentaablus', '    Käibe puhasrentaablus', '     Varade puhasrentaablus', '     Omakapitali puhasrentaablus'];
         ...
         //   left: '1%'
          ...
          tooltip: {
            ...
            formatter: function(params) {
              ...
              if (params.value[1] == 0) {var zz = " Käibe ärirentaablus"}
