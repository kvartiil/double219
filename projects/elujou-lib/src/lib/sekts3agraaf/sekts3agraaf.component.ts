...
@Component({
  selector: 'sekts3agraaf',
  templateUrl: './sekts3agraaf.component.html',
  styleUrls: [ './sekts3agraaf.component.scss' ],
  standalone: true,
...
export class Sekts3agraafComponent implements OnInit  {
  ...
  constructor () {
    ...
    this.newdata =  [   //Iga valdkonna jaoks on eraldi datamatrix
      [this.kysiVK(), 0, 4],  //Esimesel kohal number tähendab näitaja suurust (antud juhul 1.4)
      [this.minuVK, 0, 4.01],
      [this.kysiKOS(), 1, 4], //Teisel kohal näitaja 0-kõige alumist (Varude käibesagedus), 1-keskmist (Lühiajalise võlgnevuse kattekordaja), 2-kõige kõrgemat (Vara käibesagedus)
      [this.minuKOS, 1, 4.01], //Kolmandal kohal asuv number 6 - ettevõtte info, 4 - sektori info
      [this.kysiIKK(), 2, 4],
      [this.minuIKK, 2, 4.01]
    ];
  }, 3000);
  ...
  //kysiVKK() {   //Ettevõtte varude käibesagedus. 0
    ...
    this.volaKord = Math.round((this.volaKord)*100)/100;
  return this.volaKord;
  }
  ...
  //kysiLVKAK() {  //Ettevõtte lühiajalise võlgnevuse käibekordaja. 1
    ...
    //this.lyhVolgnKaibek = this.oigeSuhtarv[0].LVKAK;
    this.kohOmak = Math.round((this.kohOmak)*100)/100;
  ...
  //kysiVAKK() {  //Ettevõtte varade käibesagedus. 2
    ...
    this.intressKate = Math.round((this.intressKate)*100)/100;
  
  return this.intressKate;
  }
...
////}
  ...
  naitajad = [
    '     Võlakordaja', '    Kohustuste ja omakapitali suhe', '     Intresside kattekordaja'
  ];
         ...
         //   left: '1%'
          ...
          tooltip: {
            ...
            formatter: function(params) {
              ...
              if (params.value[1] == 0) {var zz = " Võlakordaja"}
              if (params.value[1] == 1) {var zz = " Kohustuste ja omakapitali suhe"}
              if (params.value[1] == 2) {var zz = " Intresside kattekordaja"}
